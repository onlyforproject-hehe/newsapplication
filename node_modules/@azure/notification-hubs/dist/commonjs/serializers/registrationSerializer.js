...
exports.registrationDescriptionSerializer = exports.registrationDescriptionParser = void 0;
const utils_js_1 = require("../utils/utils.js");
const core_xml_1 = require("@azure/core-xml");
const core_rest_pipeline_1 = require("@azure/core-rest-pipeline");
const xmlUtils_js_1 = require("../utils/xmlUtils.js");
exports.registrationDescriptionParser = {
    /**
     * @internal
    ...
    async parseRegistrationEntry(bodyText) {
        ...
        if (!methodName) {
            throw new core_rest_pipeline_1.RestError(`${keyName} is not a supported registration type`, { statusCode: 500 });
        }
    ...
    createAdmRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ admRegistrationId: (0, utils_js_1.getString)(rawRegistrationDescription["AdmRegistrationId"], "admRegistrationId") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Adm" });
    },
    /**
     * @internal
    ...
    createAppleRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ deviceToken: (0, utils_js_1.getString)(rawRegistrationDescription["DeviceToken"], "deviceToken") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Apple" });
    },
    /**
     * @internal
    ...
    createAppleTemplateRegistrationDescription(rawRegistrationDescription) {
        var _a;
        return Object.assign(Object.assign(Object.assign({ priority: (0, utils_js_1.getStringOrUndefined)(rawRegistrationDescription["Priority"]), apnsHeaders: getHeadersOrUndefined((_a = rawRegistrationDescription["ApnsHeaders"]) === null || _a === void 0 ? void 0 : _a["ApnsHeader"]) }, this.createAppleRegistrationDescription(rawRegistrationDescription)), createTemplateRegistrationDescription(rawRegistrationDescription)), { kind: "AppleTemplate" });
    },
    /**
     * @internal
    ...
    createBaiduRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ baiduChannelId: (0, utils_js_1.getString)(rawRegistrationDescription["BaiduChannelId"], "baiduChannelId"), baiduUserId: (0, utils_js_1.getString)(rawRegistrationDescription["BaiduUserId"], "baiduUserId") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Baidu" });
    },
    /**
     * @internal
    ...
    createBrowserRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ endpoint: (0, utils_js_1.getString)(rawRegistrationDescription["Endpoint"], "endpoint"), p256dh: (0, utils_js_1.getString)(rawRegistrationDescription["P256DH"], "p256dh"), auth: (0, utils_js_1.getString)(rawRegistrationDescription["Auth"], "auth") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Browser" });
    },
    /**
     * @internal
    ...
    createFcmV1RegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ fcmV1RegistrationId: (0, utils_js_1.getString)(rawRegistrationDescription["FcmV1RegistrationId"], "fcmV1RegistrationId") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "FcmV1" });
    },
    /**
     * @internal
    ...
    createGcmRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ gcmRegistrationId: (0, utils_js_1.getString)(rawRegistrationDescription["GcmRegistrationId"], "gcmRegistrationId") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Gcm" });
    },
    /**
     * @internal
     * Creates an FCM template registration description from incoming XML property bag.
    ...
    createMpnsRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ channelUri: (0, utils_js_1.getString)(rawRegistrationDescription["ChannelUri"], "channelUri") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Mpns" });
    },
    /**
     * @internal
    ...
    createXiaomiRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ xiaomiRegistrationId: (0, utils_js_1.getString)(rawRegistrationDescription["XiaomiRegistrationId"], "xiaomiRegistrationId") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Xiaomi" });
    },
    /**
     * @internal
    ...
    createWindowsRegistrationDescription(rawRegistrationDescription) {
        return Object.assign(Object.assign({ channelUri: (0, utils_js_1.getString)(rawRegistrationDescription["ChannelUri"], "channelUri") }, createRegistrationDescription(rawRegistrationDescription)), { kind: "Windows" });
    },
    /**
     * @internal
...
function createRegistrationDescription(rawRegistrationDescription) {
    let pushVariables;
    const unparsed = (0, utils_js_1.getStringOrUndefined)(rawRegistrationDescription["PushVariables"]);
    if (unparsed) {
        pushVariables = JSON.parse(unparsed);
    }
    return {
        registrationId: (0, utils_js_1.getStringOrUndefined)(rawRegistrationDescription["RegistrationId"]),
        expirationTime: (0, utils_js_1.getDateOrUndefined)(rawRegistrationDescription["ExpirationTime"]),
        etag: (0, utils_js_1.getStringOrUndefined)(rawRegistrationDescription["ETag"]),
...
function createTemplateRegistrationDescription(rawRegistrationDescription) {
    return Object.assign({ bodyTemplate: (0, utils_js_1.getString)(rawRegistrationDescription["BodyTemplate"], "bodyTemplate"), templateName: (0, utils_js_1.getStringOrUndefined)(rawRegistrationDescription["TemplateName"]) }, createRegistrationDescription(rawRegistrationDescription));
}
/**
 * Represents a RegistrationDescription serializer.
 */
exports.registrationDescriptionSerializer = {
    serializeRegistrationDescription(description) {
        ...
        if (!(0, utils_js_1.isDefined)(method)) {
            throw new core_rest_pipeline_1.RestError(`Undefined platform ${description.kind}`, { statusCode: 400 });
        }
        const registration = method(description);
        const requestObject = (0, xmlUtils_js_1.serializeToAtomXmlRequest)(rootName, registration);
        return (0, core_xml_1.stringifyXML)(requestObject, { rootName: "entry" });
    },
    /**
     * @internal
    ...
    serializeAdmRegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { AdmRegistrationId: (0, utils_js_1.getString)(description.admRegistrationId, "admRegistrationId") });
    },
    /**
     * @internal
    ...
    serializeAppleRegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { DeviceToken: (0, utils_js_1.getString)(description.deviceToken, "deviceToken") });
    },
    /**
     * @internal
    ...
    serializeAppleTemplateRegistrationDescription(description) {
        ...
        return Object.assign(Object.assign(Object.assign({}, this.serializeAppleRegistrationDescription(description)), serializeTemplateRegistrationDescription(description)), { Expiry: (0, utils_js_1.getStringOrUndefined)(description.expiry), ApnsHeaders: apnsHeaders });
    },
    /**
     * @internal
    ...
    serializeBaiduRegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { BaiduChannelId: (0, utils_js_1.getString)(description.baiduChannelId, "baiduChannelId"), BaiduUserId: (0, utils_js_1.getString)(description.baiduUserId, "baiduUserId") });
    },
    /**
     * @internal
    ...
    serializeFcmV1RegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { FcmV1RegistrationId: (0, utils_js_1.getString)(description.fcmV1RegistrationId, "fcmRegistrationId") });
    },
    /**
     * @internal
    ...
    serializeGcmRegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { GcmRegistrationId: (0, utils_js_1.getString)(description.gcmRegistrationId, "gcmRegistrationId") });
    },
    /**
     * @internal
    ...
    serializeXiaomiRegistrationDescription(description) {
        return Object.assign(Object.assign({}, serializeRegistrationDescription(description)), { XiaomiRegistrationId: (0, utils_js_1.getString)(description.xiaomiRegistrationId, "xiaomiRegistrationId") });
    },
    /**
     * @internal
...
function serializeRegistrationDescription(description) {
    ...
    return {
        RegistrationId: (0, utils_js_1.getStringOrUndefined)(description.registrationId),
        Tags: tags,
        PushVariables: pushVariables,
    };
}
function serializeTemplateRegistrationDescription(description) {
    return {
        ...
        TemplateName: (0, utils_js_1.getStringOrUndefined)(description.templateName),
    };
}
